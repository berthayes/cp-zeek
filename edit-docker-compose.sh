...
/bin/sed -e 's/      CONTROL_CENTER_KSQL_KSQLDB1_ADVERTISED_URL: \"http:\/\/localhost:8088\"/      CONTROL_CENTER_KSQL_KSQLDB1_ADVERTISED_URL: \"http:\/\/'$1'.'$WORKSHOP_DOMAIN':443\"/' -e 's/      - "9021:9021"/      -"80:9021"/' -e 's/      - "8088:8088"/      -"443:8088"/' $DOCKER_COMPOSE_FILE > workshop-docker-compose.yml
...
#/bin/sed -e 's/      CONTROL_CENTER_KSQL_KSQLDB1_ADVERTISED_URL: \"http:\/\/ksqldb-server:8088\"/      CONTROL_CENTER_KSQL_KSQLDB1_ADVERTISED_URL: \"http:\/\/'$1'.'$WORKSHOP_DOMAIN':8088\"/' $DOCKER_COMPOSE_FILE > workshop-docker-compose.yml
